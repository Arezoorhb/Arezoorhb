        ...
        <div>
            <div>
                <div className=" p-16 h-[1000px]  w-[full]   bg-[url('./image/hero_2.jpg')] mix-blend-overlay ">
                    ...
                    <div
                        className=" flex justify-items-center rounded-xl ml-40 text-center mt-36 w-3/4 h-46 bg-white opacity-70	">
                        <input placeholder="What are you looking for? " type="text"
                               className="border  rounded m-4 h-8 w-56 p-2 opacity-100"/>
                        <input placeholder="Location " type="text"
                               className="border  rounded m-4 h-8 w-56 p-2 opacity-100"/>
                        {/*<input type="text" className="border rounded m-4 h-8 w-56 p-2 " />*/}
                        <select className="border rounded m-4 h-8 w-56 pl-2 opacity-100">
