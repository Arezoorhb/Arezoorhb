...
const App = () => {
    return (
        <div>
            <div>
                <div className="  h-[1000px]  w-[full]   bg-[url('./image/hero_2.jpg')]  pt-20 bg-cover ">
                ...
                <Navbar/>
                    ...
                    <div className="flex justify-center w-full">
                        ...
                        <div
                            className="h-96 w-[500px] p-4 relative ml-30 bg-contain bg-no-repeat  bg-[url('./image/img_2.jpg')]  grid content-center transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110">
                            <div className="bg-black absolute w-[447px] h-96 opacity-40 z-0 "></div>
                        ...
                        <div
                            className="h-96 w-[500px] p-4 relative rounded  bg-no-repeat bg-contain bg-[url('./image/img_3.jpg')]  grid content-center transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110">
                            <div className="bg-black absolute w-[447px] h-96 opacity-40"></div>
                            <a href="#"
                               className="bg-emerald-600 w-32 h-8 mt-60 rounded-xl  text-center  p-1 text-white ">car
                                and vehicles</a>
                            <a href="#" className="text-2xl text-white block  mt-4">Red Luxury Car</a>
                    ...
                    <div className="bg-gray-100 w-full h-3/4 mt-12 p-4 ">
                        <h1 className="text-4xl text-green-600 m-4">Trending Today</h1>
                    ...
                    {/*--------------------------------------------------------------------------------------------------*/}
                    <div className="bg-gray-100 h-[700px] w-full flex-col  p-12 ">


                        <div className>
                            <h2 className="text-green-500  text-3xl text-center ">Our Blog</h2>
                        ...
                        <div className="w-full mx-aut flex  items-center justify-center mt-12  ">
                    ...
                    {/*-----------------------------------------EMAIL------------------------------------------------*/}
                    <div className="bg-emerald-400 w-full h-40 flex justify-center p-8 ">
                        <div className=" text-white text-xl p-4  w-[600px]">
                            <h2>Newsletter</h2>
                        ...
                        <div className="p-4 w-[600px]">
                            ...
                            <input placeholder="Email "
                                   className="bg-emerald-400 text-white  border-b-2 border-0 w-96 	"/>
                    ...
                    {/*------------------------------------------------------------------------------------*/}
                    <div className="bg-gray-900 w-full h-[600px] flex   justify-center ">
                        <div className="w-auto h-96 flex justify-center mt-40">
